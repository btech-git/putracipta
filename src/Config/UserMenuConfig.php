...
class UserMenuConfig
{
    public static function getMenuHierarchy(): array
    {
        return [
            ...
            'MENU_REPORT_PURCHASE' => [
                'MENU_REPORT_PURCHASE_REQUEST_MATERIAL', 'MENU_REPORT_PURCHASE_REQUEST_PAPER', 'MENU_REPORT_PURCHASE_ORDER_MATERIAL', 
                'MENU_REPORT_PURCHASE_ORDER_PAPER', 'MENU_REPORT_PURCHASE_INVOICE', 'MENU_REPORT_PURCHASE_PAYMENT'
            ],
    ...
    public static function getMenuAttributes(): array
    {
        return [
            ...
            'MENU_EMPLOYEE' => ['route' => 'app_master_employee_index', 'pattern' => '/^app_master_employee_.+$/', 'roles' => ['ROLE_EMPLOYEE_ADD', 'ROLE_EMPLOYEE_EDIT']],
            'MENU_SUPPLIER' => ['route' => 'app_master_supplier_index', 'pattern' => '/^app_master_supplier_.+$/', 'roles' => ['ROLE_SUPPLIER_ADD', 'ROLE_SUPPLIER_EDIT']],
            ...
            'MENU_WORK_ORDER_PROCESS' => ['route' => 'app_master_work_order_process_index', 'pattern' => '/^app_master_work_order_process_.+$/', 'roles' => ['ROLE_PROCESS_ADD', 'ROLE_PROCESS_EDIT']],
            'MENU_WORK_ORDER_DISTRIBUTION' => ['route' => 'app_master_work_order_distribution_index', 'pattern' => '/^app_master_work_order_distribution_.+$/', 'roles' => ['ROLE_DISTRIBUTION_ADD', 'ROLE_DISTRIBUTION_EDIT']],
            'MENU_WORK_ORDER_CHECK_SHEET' => ['route' => 'app_master_work_order_check_sheet_index', 'pattern' => '/^app_master_work_order_check_sheet_.+$/', 'roles' => ['ROLE_CHECK_SHEET_ADD', 'ROLE_CHECK_SHEET_EDIT']],
            'MENU_MACHINE_PRINTING' => ['route' => 'app_master_machine_printing_index', 'pattern' => '/^app_master_machine_printing_.+$/', 'roles' => ['ROLE_PRINTING_MACHINE_ADD', 'ROLE_PRINTING_MACHINE_EDIT']],
            'MENU_MATERIAL_CATEGORY' => ['route' => 'app_master_material_category_index', 'pattern' => '/^app_master_material_category_.+$/', 'roles' => ['ROLE_MATERIAL_CATEGORY_ADD', 'ROLE_MATERIAL_CATEGORY_EDIT']],
            'MENU_MATERIAL_SUB_CATEGORY' => ['route' => 'app_master_material_sub_category_index', 'pattern' => '/^app_master_material_sub_category_.+$/', 'roles' => ['ROLE_MATERIAL_SUB_CATEGORY_ADD', 'ROLE_MATERIAL_SUB_CATEGORY_EDIT']],
            ...
            'MENU_PURCHASE_REQUEST_PAPER' => ['route' => 'app_purchase_purchase_request_paper_header_index', 'pattern' => '/^app_purchase_purchase_request_paper_header_.+$/', 'roles' => ['ROLE_PURCHASE_REQUEST_PAPER_ADD', 'ROLE_PURCHASE_REQUEST_PAPER_EDIT']],
            'MENU_PURCHASE_ORDER_MATERIAL' => ['route' => 'app_purchase_purchase_order_header_index', 'pattern' => '/^app_purchase_purchase_order_header_.+$/', 'roles' => ['ROLE_PURCHASE_ORDER_MATERIAL_ADD', 'ROLE_PURCHASE_ORDER_MATERIAL_EDIT']],
            'MENU_PURCHASE_ORDER_PAPER' => ['route' => 'app_purchase_purchase_order_paper_header_index', 'pattern' => '/^app_purchase_purchase_order_paper_header_.+$/', 'roles' => ['ROLE_PURCHASE_ORDER_PAPER_ADD', 'ROLE_PURCHASE_ORDER_PAPER_EDIT']],
            'MENU_PURCHASE_INVOICE' => ['route' => 'app_purchase_purchase_invoice_header_index', 'pattern' => '/^app_purchase_purchase_invoice_header_.+$/', 'roles' => ['ROLE_PURCHASE_INVOICE_ADD', 'ROLE_PURCHASE_INVOICE_EDIT']],
            'MENU_PURCHASE_PAYMENT' => ['route' => 'app_purchase_purchase_payment_header_index', 'pattern' => '/^app_purchase_purchase_payment_header_.+$/', 'roles' => ['ROLE_PURCHASE_PAYMENT_ADD', 'ROLE_PURCHASE_PAYMENT_EDIT']],
            'MENU_SALE_ORDER' => ['route' => 'app_sale_sale_order_header_index', 'pattern' => '/^app_sale_sale_order_header_.+$/', 'roles' => ['ROLE_SALE_ORDER_ADD', 'ROLE_SALE_ORDER_EDIT']],
            'MENU_SALE_INVOICE' => ['route' => 'app_sale_sale_invoice_header_index', 'pattern' => '/^app_sale_sale_invoice_header_.+$/', 'roles' => ['ROLE_SALE_INVOICE_ADD', 'ROLE_SALE_INVOICE_EDIT']],
            'MENU_SALE_PAYMENT' => ['route' => 'app_sale_sale_payment_header_index', 'pattern' => '/^app_sale_sale_payment_header_.+$/', 'roles' => ['ROLE_SALE_PAYMENT_ADD', 'ROLE_SALE_PAYMENT_EDIT']],
            'MENU_PURCHASE_RECEIVE' => ['route' => 'app_purchase_receive_header_index', 'pattern' => '/^app_purchase_receive_header_.+$/', 'roles' => ['ROLE_RECEIVE_ADD', 'ROLE_RECEIVE_EDIT']],
            'MENU_PURCHASE_RETURN' => ['route' => 'app_purchase_purchase_return_header_index', 'pattern' => '/^app_purchase_purchase_return_header_.+$/', 'roles' => ['ROLE_PURCHASE_RETURN_ADD', 'ROLE_PURCHASE_RETURN_EDIT']],
            'MENU_ADJUSTMENT_STOCK' => ['route' => 'app_stock_adjustment_stock_header_index', 'pattern' => '/^app_stock_adjustment_stock_header_.+$/', 'roles' => ['ROLE_ADJUSTMENT_ADD', 'ROLE_ADJUSTMENT_EDIT']],
            'MENU_MATERIAL_REQUEST' => ['route' => 'app_stock_inventory_request_header_index', 'pattern' => '/^app_stock_inventory_request_header_.+$/', 'roles' => ['ROLE_MATERIAL_REQUEST_ADD', 'ROLE_MATERIAL_REQUEST_EDIT']],
            'MENU_MATERIAL_RELEASE' => ['route' => 'app_stock_inventory_release_header_index', 'pattern' => '/^app_stock_inventory_release_header_.+$/', 'roles' => ['ROLE_MATERIAL_RELEASE_ADD', 'ROLE_MATERIAL_RELEASE_EDIT']],
            'MENU_STOCK_TRANSFER' => ['route' => 'app_stock_stock_transfer_header_index', 'pattern' => '/^app_stock_stock_transfer_header_.+$/', 'roles' => ['ROLE_TRANSFER_ADD', 'ROLE_TRANSFER_EDIT']],
            'MENU_SALE_DELIVERY' => ['route' => 'app_sale_delivery_header_index', 'pattern' => '/^app_sale_delivery_header_.+$/', 'roles' => ['ROLE_DELIVERY_ADD', 'ROLE_DELIVERY_EDIT']],
            'MENU_SALE_RETURN' => ['route' => 'app_sale_sale_return_header_index', 'pattern' => '/^app_sale_sale_return_header_.+$/', 'roles' => ['ROLE_SALE_RETURN_ADD', 'ROLE_SALE_RETURN_EDIT']],
            'MENU_PRODUCTION_RECEIVE' => ['route' => 'app_stock_inventory_product_receive_header_index', 'pattern' => '/^app_stock_inventory_product_receive_header_.+$/', 'roles' => ['ROLE_FINISHED_GOODS_RECEIVE_ADD', 'ROLE_FINISHED_GOODS_RECEIVE_EDIT']],
            ...
            'MENU_REPORT_MATERIAL_REQUEST' => ['route' => 'app_report_inventory_request_header_index', 'pattern' => '/^app_report_inventory_request_header_.+$/', 'roles' => ['ROLE_INVENTORY_MATERIAL_REPORT']],
