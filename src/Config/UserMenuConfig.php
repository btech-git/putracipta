...
class UserMenuConfig
{
    ...
    public static function getMenuAttributes(): array
    {
        return [
            ...
            'MENU_REPORT_PURCHASE_INVOICE' => ['route' => 'app_report_purchase_invoice_header_index', 'pattern' => '/^app_report_purchase_invoice_header_.+$/', 'roles' => ['ROLE_FINANCE_REPORT']],
            'MENU_REPORT_PURCHASE_PAYMENT' => ['route' => 'app_report_purchase_payment_header_index', 'pattern' => '/^app_report_purchase_payment_header_.+$/', 'roles' => ['ROLE_FINANCE_REPORT']],
            ...
            'MENU_REPORT_SALE_INVOICE' => ['route' => 'app_report_sale_invoice_header_index', 'pattern' => '/^app_report_sale_invoice_header_.+$/', 'roles' => ['ROLE_FINANCE_REPORT']],
            'MENU_REPORT_SALE_PAYMENT' => ['route' => 'app_report_sale_payment_header_index', 'pattern' => '/^app_report_sale_payment_header_.+$/', 'roles' => ['ROLE_FINANCE_REPORT']],
