...
{
    #[Route('/_list', name: 'app_production_work_order_cutting_header__list', methods: ['GET'])]
    #[IsGranted('ROLE_USER')]
    public function _list(Request $request, WorkOrderCuttingHeaderRepository $workOrderCuttingHeaderRepository): Response
    {
        $criteria = new DataCriteria();
        $form = $this->createForm(WorkOrderCuttingHeaderGridType::class, $criteria, ['method' => 'GET']);
