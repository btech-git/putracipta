...
{
    #[Route('/_list', name: 'app_production_work_order_varnish_header__list', methods: ['GET'])]
    #[IsGranted('ROLE_USER')]
    public function _list(Request $request, WorkOrderVarnishHeaderRepository $workOrderVarnishHeaderRepository): Response
    {
        $criteria = new DataCriteria();
        $form = $this->createForm(WorkOrderVarnishHeaderGridType::class, $criteria, ['method' => 'GET']);
