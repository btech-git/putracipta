...
class PurchaseOrderHeaderController extends AbstractController
{
    ...
    #[Security("is_granted('ROLE_PURCHASE_ORDER_MATERIAL_ADD') or is_granted('ROLE_PURCHASE_ORDER_MATERIAL_EDIT') or is_granted('ROLE_PURCHASE_ORDER_MATERIAL_VIEW') or is_granted('ROLE_PURCHASE_ORDER_MATERIAL_APPROVAL')")]
