...
class PurchaseRequestPaperHeaderController extends AbstractController
{
    ...
    public function _list(Request $request, PurchaseRequestPaperHeaderRepository $purchaseRequestPaperHeaderRepository): Response
    {
        ...
        if ($request->request->has('export')) {
            return $this->export($form, $purchaseRequestPaperHeaders);
        } else {
    ...
    public function export(FormInterface $form, array $purchaseRequestPaperHeaders): Response
    {
        $htmlString = $this->renderView("report/purchase_request_paper_header/_list_export.html.twig", [
        ...
        $filename = 'puchase_request_paper.xlsx';
