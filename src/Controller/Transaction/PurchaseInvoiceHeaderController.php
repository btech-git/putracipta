...
class PurchaseInvoiceHeaderController extends AbstractController
{
    ...
    #[Route('/_head', name: 'app_transaction_purchase_invoice_header__head', methods: ['GET'])]
    #[IsGranted('ROLE_USER')]
    public function _head(Request $request, PurchaseInvoiceHeaderRepository $purchaseInvoiceHeaderRepository): Response
    {
        ...
        return $this->renderForm("transaction/purchase_invoice_header/_head.html.twig", [
            'form' => $form,
            'count' => $count,
            'purchaseInvoiceHeaders' => $purchaseInvoiceHeaders,
        ]);
    ...
    #[Route('/head', name: 'app_transaction_purchase_invoice_header_head', methods: ['GET'])]
    #[IsGranted('ROLE_USER')]
