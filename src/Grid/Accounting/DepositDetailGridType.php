...
class DepositDetailGridType extends AbstractType
{
    public function buildForm(FormBuilderInterface $builder, array $options): void
    {
        $builder
            ->add('filter', FilterType::class, [
                'field_names' => ['description', 'amount', 'isCanceled', 'memo'],
                'field_operators_list' => [
                    'description' => [FilterContain::class, FilterNotContain::class],
                    'amount' => [FilterEqual::class, FilterNotEqual::class],
            ...
            ->add('sort', SortType::class, [
                ...
                'field_operators_list' => [
                    ...
                    'amount' => [SortAscending::class, SortDescending::class],
