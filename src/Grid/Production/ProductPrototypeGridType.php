    ...
    public function buildForm(FormBuilderInterface $builder, array $options): void
    {
        $builder
            ->add('filter', FilterType::class, [
                'field_names' => ['codeNumberOrdinal', 'codeNumberMonth', 'codeNumberYear', 'transactionDate', 'customer:company', 'designCode:code', 'designCode:variant', 'designCode:version', 'paper:name', 'note'],
                'field_label_list' => [
            ...
            ->add('sort', SortType::class, [
                'field_names' => ['customer:company', 'designCode:code', 'paper:name', 'transactionDate', 'note', 'id'],
                'field_label_list' => [
                    'codeNumberOrdinal' => 'Code Number',
                    'codeNumberMonth' => '',
                    'codeNumberYear' => '',
