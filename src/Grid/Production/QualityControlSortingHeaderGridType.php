    ...
    public function buildForm(FormBuilderInterface $builder, array $options): void
    {
        $builder
            ->add('filter', FilterType::class, [
                'field_names' => ['employeeInCharge', 'isCanceled', 'codeNumberOrdinal', 'codeNumberMonth', 'codeNumberYear', 'createdTransactionDateTime', 'modifiedTransactionDateTime', 'transactionDate', 'note', 'codeNumberVersion'],
                'field_operators_list' => [
                    ...
                    'codeNumberVersion' => [FilterEqual::class, FilterNotEqual::class],
                ],
            ])
            ->add('sort', SortType::class, [
                ...
                'field_operators_list' => [
                    ...
                    'codeNumberVersion' => [SortAscending::class, SortDescending::class],
                ],
            ])
