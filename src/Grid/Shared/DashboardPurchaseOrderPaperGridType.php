...
class DashboardPurchaseOrderPaperGridType extends AbstractType
{
    public function buildForm(FormBuilderInterface $builder, array $options): void
    {
        $builder
            ->add('filter', FilterType::class, [
                'field_names' => ['codeNumberOrdinal', 'codeNumberMonth', 'codeNumberYear', 'transactionDate', 'supplier:company', 'purchaseOrderPaperList'],
                'field_label_list' => [
                ...
                'field_operators_list' => [
                    ...
                    'purchaseOrderPaperList' => [FilterContain::class, FilterNotContain::class],
                ],
            ...
            ->add('sort', SortType::class, [
                'field_names' => ['transactionDate', 'supplier:company', 'purchaseOrderPaperList', 'codeNumberYear', 'codeNumberMonth', 'codeNumberOrdinal'],
                'field_label_list' => [
                    'codeNumberOrdinal' => '',
                    'codeNumberMonth' => '',
                ...
                'field_operators_list' => [
                    ...
                    'purchaseOrderPaperList' => [SortAscending::class, SortDescending::class],
                ],
            ])
