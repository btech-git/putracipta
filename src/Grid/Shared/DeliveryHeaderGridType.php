    ...
    public function buildForm(FormBuilderInterface $builder, array $options): void
    {
        $builder
            ->add('filter', FilterType::class, [
                'field_names' => ['totalQuantity', 'customerDeliveryCodeNumber', 'isCanceled', 'codeNumberOrdinal', 'codeNumberMonth', 'codeNumberYear', 'createdTransactionDateTime', 'modifiedTransactionDateTime', 'approvedTransactionDateTime', 'transactionDate', 'note'],
                'field_operators_list' => [
                    'totalQuantity' => [FilterEqual::class, FilterNotEqual::class],
                    'customerDeliveryCodeNumber' => [FilterContain::class, FilterNotContain::class],
            ...
            ->add('sort', SortType::class, [
                ...
                'field_operators_list' => [
                    ...
                    'customerDeliveryCodeNumber' => [SortAscending::class, SortDescending::class],
