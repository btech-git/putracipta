...
class StockTransferHeaderGridType extends AbstractType
{
    public function buildForm(FormBuilderInterface $builder, array $options): void
    {
        $builder
            ->add('filter', FilterType::class, [
                'field_names' => ['codeNumberOrdinal', 'codeNumberMonth', 'codeNumberYear', 'transactionDate', 'warehouseFrom', 'warehouseTo', 'note'],
                'field_label_list' => [
                ...
                'field_operators_list' => [
                    ...
                    'warehouseFrom' => [FilterEqual::class, FilterNotEqual::class],
                    'WarehouseTo' => [FilterEqual::class, FilterNotEqual::class],
                ...
                'field_value_type_list' => [
                    ...
                    'warehouseFrom' => EntityType::class,
                    'warehouseTo' => EntityType::class,
                ],
                'field_value_options_list' => [
                    ...
                    'warehouseFrom' => ['class' => Warehouse::class, 'choice_label' => 'name'],
                    'warehouseTo' => ['class' => Warehouse::class, 'choice_label' => 'name'],
                ],
            ])
            ->add('sort', SortType::class, [
                'field_names' => ['transactionDate', 'codeNumberYear', 'codeNumberMonth', 'codeNumberOrdinal'],
                'field_label_list' => [
                    'codeNumberOrdinal' => '',
                    'codeNumberMonth' => '',
