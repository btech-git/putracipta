    ...
    public function buildForm(FormBuilderInterface $builder, array $options): void
    {
        $builder
            ->add('filter', FilterType::class, [
                'field_names' => ['codeNumberOrdinal', 'codeNumberMonth', 'codeNumberYear', 'transactionDate', 'referenceNumber', 'customer:company', 'grandTotal', 'note', 'transactionStatus'],
                'field_label_list' => [
            ...
            ->add('sort', SortType::class, [
                'field_names' => ['transactionDate', 'customer:company', 'grandTotal', 'referenceNumber', 'note', 'transactionStatus', 'codeNumberYear', 'codeNumberMonth', 'codeNumberOrdinal'],
                'field_label_list' => [
                    'codeNumberOrdinal' => '',
                    'codeNumberMonth' => '',
